...
public class PlayerSkin extends ComponentSkin {
    ...
    public PlayerSkin(String name, String way, int price, Type type, Shop shop) {
        ...
        frameDelay = 10;
        this.shop = shop;
        this.mainSkin = new ImageIcon(Objects.requireNonNull(getClass().getResource(way)));
    ...
    public void addSkinsLeft(String name){
        for(int i = 0;i<3;i++){
            moveLeftSkins.add(new ImageIcon(Objects.requireNonNull(getClass().getResource("/skins/player/" + name + "/" + name + "Left" + (i + 1) + ".png"))));
        }
    }
    ...
    public void addSkinsRight(String name){
        for(int i = 0;i<3;i++){
            moveRightSkins.add(new ImageIcon(Objects.requireNonNull(getClass().getResource("/skins/player/" + name + "/" + name + "Right" + (i + 1) + ".png"))));
        }
    }
