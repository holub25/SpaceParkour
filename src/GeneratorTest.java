...
class GeneratorTest {
    ...
    void difficultyYTest() {
        ...
        assertEquals(850, generator.difficultyY(lastY));
        score.setPlayerScore(25);
        assertEquals(800, generator.difficultyY(lastY));
        score.setPlayerScore(35);
        assertEquals(750, generator.difficultyY(lastY));
        score.setPlayerScore(45);
        assertEquals(725, generator.difficultyY(lastY));
        score.setPlayerScore(60);
        assertEquals(700, generator.difficultyY(lastY));
    }
